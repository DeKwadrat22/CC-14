...
public sealed partial class RitualReagentPuddleBehavior : RitualCustomBehavior
{
    ...
    public override bool Execute(RitualData args, out string? outstr)
    {
        ...
        var solutionSys = args.EntityManager.System<Content.Shared.Chemistry.EntitySystems.SharedSolutionContainerSystem>();
        ...
        foreach (var ent in lookup)
        {
            ...
            // SolutionComponent.Solution is access-restricted; use the system API to fetch
            // the raw Solution and call ContainsPrototype on it.
            if (!solutionSys.TryGetSolution(ent, puddle.SolutionName, out _, out var solution))
                continue;
