...
using Content.Shared._ClawCommand.Lavaland.Shuttles;
using Content.Shared._ClawCommand.Lavaland.Shuttles.Components;
using Content.Shared._ClawCommand.Lavaland.Shuttles.Systems;
...
namespace Content.Server._ClawCommand.Lavaland.Shuttles.Systems;
...
public sealed partial class DockingConsoleSystem : SharedDockingConsoleSystem
{
    ...
    private readonly ResPath _miningShuttlePath = new("/Maps/_ClawCommand/Lavaland/mining.yml");
