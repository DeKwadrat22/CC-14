...
namespace Content.Server._ClawCommand.Lavaland.Biome;
...
/// </summary>
public sealed partial class LavalandMapOptimizationSystem : EntitySystem
{
    // Mirrors the protected SharedBiomeSystem.ChunkSize constant so we don't have
    // to widen its visibility on a vanilla file (additive port rule).
