...
public sealed partial class BlindHealingSystem : SharedBlindHealingSystem
{
    ...
    private void OnInteract(EntityUid uid, BlindHealingComponent component, ref AfterInteractEvent args)
    {
        if (args.Handled
            ...
            // _ClawCommand: upstream split DamageContainerID off DamageableComponent into InjurableComponent.DamageContainer.
            || (TryComp<InjurableComponent>(args.User, out var injurable) && injurable.DamageContainer != null && !component.DamageContainers.Contains(injurable.DamageContainer.Value))
