...
# Claw Command - ghost-role-information-familiar-rules is NOT defined here. The fork already has it in
# ghost/roles/ghost-role-component.ftl, wired into the role-type colour scheme, which this one was not.
