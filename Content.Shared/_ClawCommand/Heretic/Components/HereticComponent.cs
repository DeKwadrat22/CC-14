...
public sealed partial class HereticComponent : Component
{
    ...
    [DataField]
    // Claw Command: "bloodCrawl" upstream sound collection isn't defined in this fork; substituted with existing "blood" collection.
    public SoundSpecifier? InfluenceGainSound = new SoundCollectionSpecifier("blood");
