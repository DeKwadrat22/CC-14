...
public abstract partial class SharedHereticAbilitySystem
{
    ...
    {
        // Upstream DropHandItemsEvent has no Handled/Cancelled field; the ascension
        // loses its "keep blade on stun" feature here. Could be fully restored by
        // extending upstream's event with a Handled flag.
    }
    ...
    {
        // Upstream BeforeStaminaDamageEvent has no Source field; cancel any positive
        // stamina damage. This makes Blade ascension fully stamina-immune.
        if (args.Value <= 0)
            return;
