...
public partial record struct ElectricalAnomalySettings()
{
    ...
    /// <summary>
    /// <remarks>
    ///     Claw Command - was a float of seconds upstream; EmpSystem.EmpPulse now takes a TimeSpan,
    ///     and ElectricityAnomalyComponent stores it the same way, so this matches both.
    /// </remarks>
