...
namespace Content.Shared.Abilities.Psionics
{
    ...
    public sealed partial class PsionicPowerUsedEvent : HandledEntityEventArgs
    {
    ...
    public sealed partial class OnAttemptPowerUseEvent : CancellableEntityEventArgs
    {
        public EntityUid User { get; }
        public string Power = string.Empty;
    ...
    [Serializable]
    [NetSerializable]
    public sealed partial class PsionicsChangedEvent : EntityEventArgs
    {
