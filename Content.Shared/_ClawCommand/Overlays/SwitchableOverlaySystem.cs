...
// Fork adaptations: stripped FlashDurationMultiplierEvent (Goob-specific flashbang hook not present in this fork).
...
public abstract partial class SwitchableOverlaySystem<TComp, TEvent> : EntitySystem
    ...
    where TEvent : InstantActionEvent
{
    ...
    private void Toggle(EntityUid uid, TComp component, bool activate, bool playSound = true)
    {
        ...
        _actions.SetToggled(component.ToggleActionEntity, activate);
        Dirty(uid, component);
    }
