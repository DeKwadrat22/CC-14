...
public sealed partial class ShadekinSystem : EntitySystem
{
    ...
    // Fixed dark-vision tint (Floof tinted by the character's eye color, but this fork's organ-based
    // body locks eye color behind an access restriction, so a constant shadekin-lavender is used).
    private static readonly Vector3 TintColor = new(0.72f, 0.6f, 0.85f);
    ...
    public override void Update(float frameTime)
    {
        ...
        UpdateShader(TintColor, tintIntensity);
    }
