...
public sealed partial class HereticShapeshiftRadialMenu : RadialMenu
{
    ...
    private void RefreshUI()
    {
        ...
        foreach (var polymorph in action.Polymorphs)
        {
            ...
            // Upstream PolymorphConfiguration.Entity is non-nullable EntProtoId, so no null check needed.
    ...
    public sealed partial class HereticPolymorphMenuButton : RadialMenuButtonWithSector
    {
