...
public sealed partial class ColorTintOverlay : Overlay
{
    ...
    private static readonly ProtoId<ShaderPrototype> ShaderId = "ColorTint";
    ...
    /// </summary>
    public System.Numerics.Vector3? TintColor = null;
    /// <summary>
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        if (TintColor != null)
            _shader.SetParameter("tint_color", (System.Numerics.Vector3) TintColor);
        if (TintAmount != null)
